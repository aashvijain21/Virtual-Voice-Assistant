...
def wishMe():
    ...
    if hour>=0 and hour<12:
        speak("Hello,Good Morning Aashvi Jain ")
        print("Hello,Good Morning Aashvi Jain")
    elif hour>=12 and hour<18:
        speak("Hello,Good Afternoon Aashvi Jain")
        print("Hello,Good Afternoon Aashvi Jain")
    else:
        speak("Hello,Good Evening Aashvi Jain")
        print("Hello,Good Evening Aashvi Jain")
...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak("I was built by Aashvi")
            print("I was built by Aashvi")
